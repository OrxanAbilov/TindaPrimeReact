...
const AddEditDialog = ({
  ...
  const fetchData = async () => {
    try {
      const data = await GET_CHECKLIST_CLIENT_REL_BY_CHEKLIST_ID(
        newChecklist.id
      );
  ...
  const editButtonTemplate = (rowData, { rowIndex }) => {
    return (
      <Button
        icon="pi pi-pencil"
        onClick={() => editRow(rowData, rowIndex)}
        className="p-button-rounded p-button-text"
        style={{ color: "blue" }}
      />
    );
  ...
  const deleteButtonTemplate2 = (rowData) => {
    return (
      <Button
        icon="pi pi-trash"
        onClick={() => deleteQuestion(rowData)}
        className="p-button-rounded p-button-text"
        style={{ color: "red" }}
      />
    );
  ...
  const deleteButtonTemplate3 = (rowData) => {
    return (
      <Button
        icon="pi pi-trash"
        onClick={() => deleteSalesman(rowData)}
        className="p-button-rounded p-button-text"
        style={{ color: "red" }}
      />
    );
  ...
  const handleSave = async () => {
    if (validate()) {
      ...
      const postData = {
        id: newChecklist.isCopy ? 0 : newChecklist.id,
  ...
  const fetchQuestions = async () => {
    ...
    try {
      const data = await GET_QUESTIONS_BY_CHECKLIST_ID(newChecklist.id, {
        start: 0,
        pageSize: 500,
      });
  ...
  const fetchSalesmen = async () => {
    ...
    try {
      const data = await GET_SALESMEN_BY_CHECKLIST_ID(newChecklist.id, {
        start: 0,
        pageSize: 500,
      });
  ...
  const addSelectedQuestions = () => {
    const uniqueQuestions = selectedQuestions.filter((selectedQuestion) => {
      return !questionsData.some(
        (question) =>
          question.q_ID === selectedQuestion.id ||
  ...
  const addSelectedSalesmen = () => {
    const uniqueSalesmen = selectedSalesmen.filter((selectedSalesmen) => {
      return !salesmenData.some(
        (salesman) => salesman.slS_CODE === selectedSalesmen.slS_CODE
      );
    });
  ...
  const validate = () => {
    ...
    if (!newChecklist.begiN_DATE)
      errors.begiN_DATE = "* Başlama vaxtını qeyd edin";
    ...
    >
      {loading ? (
        ...
        <div>
          <TabView>
                  ...
                  <div className="p-field" style={{ width: "33.3%" }}>
                    ...
                    <InputText
                      ...
                      onChange={(e) =>
                        setNewChecklist({
                          ...newChecklist,
                          desC_: e.target.value,
                        })
                      }
                      className="p-inputtext-lg p-d-block my-2"
                      required
                    />
                    {validationErrors.desC_ && (
                ...
                <div className="flex" style={{ gap: "2rem" }}>
                  ...
                  <div className="p-field" style={{ width: "33.3%" }}>
                    ...
                    <Dropdown
                      ...
                      onChange={(e) =>
                        setNewChecklist({ ...newChecklist, statuS_: e.value })
                      }
            ...
            <TabPanel header="Təmsilçilər">
              <div className="p-fluid">
                <Button
                  style={{ margin: "1rem 0 1rem 0" }}
                  label="Yeni Təmsilçi Əlavə Et"
                  icon="pi pi-plus"
                  onClick={() => setSalesmanDialogVisible(true)}
                />
                {salesmenLoading ? (
                  <p>Yüklənir...</p>
                ) : (
              ...
              <div className="p-fluid">
                <div className="flex" style={{ gap: "2rem" }}>
                  <div className="p-field" style={{ width: "23%" }}>
                    ...
                    <InputText
                      id="clienT_CODE"
                      value={
                        newChecklist.checkListClientRelPostDtos?.clienT_CODE
                      }
                      onChange={(e) =>
                        setNewChecklist({
                          ...newChecklist,
                  ...
                  <div className="p-field" style={{ width: "23%" }}>
                    ...
                    <InputText
                      id="clspecodE2"
                      value={
                        newChecklist.checkListClientRelPostDtos?.clspecodE2
                      }
                      onChange={(e) =>
                        setNewChecklist({
                          ...newChecklist,
                  ...
                  <div className="p-field" style={{ width: "23%" }}>
                    ...
                    <InputText
                      id="clspecodE3"
                      value={
                        newChecklist.checkListClientRelPostDtos?.clspecodE3
                      }
                      onChange={(e) =>
                        setNewChecklist({
                          ...newChecklist,
                ...
                <div className="flex" style={{ gap: "2rem" }}>
                  <div className="p-field" style={{ width: "23%" }}>
                    ...
                    <InputText
                      id="clspecodE4"
                      value={
                        newChecklist.checkListClientRelPostDtos?.clspecodE4
                      }
                      onChange={(e) =>
                        setNewChecklist({
                          ...newChecklist,
                  ...
                  <div className="p-field" style={{ width: "23%" }}>
                    ...
                    <InputText
                      id="clspecodE5"
                      value={
                        newChecklist.checkListClientRelPostDtos?.clspecodE5
                      }
                      onChange={(e) =>
                        setNewChecklist({
                          ...newChecklist,
                ...
                <div style={{ marginTop: "1rem" }}>
                  <div style={{ marginBottom: "1rem", width: "15%" }}>
                    ...
                    <Button
                      label={editMode ? "Dəyişdir" : "Əlavə et"}
                      severity="secondary"
          ...
          >
              ...
              {allQuestionsLoading ? (
                ...
                <DataTableContainer>
                  ...
                  >
                    ...
                    <Column
                      field="desc"
                      header={renderHeader("desc", "Sual")}
                    />
                    <Column
                      field="questioN_GROUP_NAME"
                      header={renderHeader("questioN_GROUP_NAME", "Sual qrupu")}
                    />
                    <Column
                      field="ratE_TYPE"
                      header={renderHeader("ratE_TYPE", "Qiymətləndirmə tipi")}
                    />
                    <Column
                      field="answeR_TYPE"
            ...
            <div className="p-dialog-footer mt-6">
              ...
              <Button
                label="Ləğv et"
                icon="pi pi-times"
                onClick={() => setQuestionDialogVisible(false)}
                className="p-button-secondary"
              />
            </div>
          </Dialog>
          ...
          <Dialog
            header="Təmsilçi seç"
            visible={salesmanDialogVisible}
            style={{ width: "70vw" }}
            modal
            onHide={() => setSalesmanDialogVisible(false)}
          >
            <div className="p-fluid">
              {allSalesmenLoading ? (
                <p>Yüklənir...</p>
            ...
            <div className="p-dialog-footer mt-6">
              <Button
                label="Əlavə et"
                icon="pi pi-check"
                onClick={addSelectedSalesmen}
                className="p-button-primary"
              />
              <Button
                label="Ləğv et"
                icon="pi pi-times"
                onClick={() => setSalesmanDialogVisible(false)}
                className="p-button-secondary"
              />
            </div>
          </Dialog>
