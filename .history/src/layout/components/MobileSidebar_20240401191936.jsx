  ...
  return (
    <Wrapper>
      ...
      <div className="min-h-screen flex relative lg:static surface-ground">
        <div id="app-sidebar-2" className="surface-section h-screen  lg:block flex-shrink-0 absolute lg:static left-0 top-0 z-1 border-right-1 surface-border select-none" style={{ width: '100%' }}>
            ...
            <div className="overflow-y-auto">
              ...
              <li>
                ...
                <li>
                  ...
                  <ul className="list-none p-0 m-0 pl-3 overflow-hidden ">
                    <li>
              ...
              {userType === 1 && (
                <ul className="list-none p-3 m-0 pt-0">
                  <li>
                    ...
                    <ul className="list-none pl-3 p-0 m-0 overflow-hidden ">
                      <li>
