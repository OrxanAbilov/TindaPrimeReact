...
import { GET_PORCUREMENT_ORDER_DOCUMENT_BY_ID } from "../../features/esd/services/api";
import { DOWNLOAD_SUGGESTION_FILE_BY_ID } from "../../features/procurement/services/api";
...
export default function PreviewDoc() {
    ...
    const fetchData = async () => {
        try {
            setIsLoading(true);
            const res = await GET_PORCUREMENT_ORDER_DOCUMENT_BY_ID(id);
            setData(res.data);
            setError(false);
        } catch (error) {
            console.log(error);
                        ...
                        <Fragment>
                            ...
                            <Information>
                                ...
                                <InfoGroup>
                                    ...
                                    <Desc>{data.suggestion.clientCode}  -  {data.suggestion.clientName}</Desc>
                                </InfoGroup>
