  ...
  const handleFilterChange = (field, value) => {
    ...
    if (field === "statuS_" && value === "all") {
      newSearchList = newSearchList.filter(
        (criteria) => criteria.colName !== "statuS_"
      );
    }
    ...
    setFilters((prevFilters) => ({
      ...prevFilters,
      [field]: value,
      searchList: newSearchList.filter(
        (criteria) =>
          criteria.value !== "" &&
          criteria.value !== null &&
          criteria.value !== undefined
  ...
  return (
    <Wrapper>
      ...
      <DataTableContainer>
        ...
        >
          ...
          <Column
            ...
            body={(rowData) => (
              <Truncate>{formatDate(rowData.begiN_DATE)}</Truncate>
            )}
          />
          <Column
            field="enD_DATE"
            ...
            body={(rowData) => (
              <Truncate>{formatDate(rowData.enD_DATE)}</Truncate>
            )}
          />
          <Column
      ...
      <AddEditDialog
        ...
        header={
          newChecklist?.id == 0 || newChecklist.isCopy ? "Əlavə et" : "Dəyişdir"
        }
      />
